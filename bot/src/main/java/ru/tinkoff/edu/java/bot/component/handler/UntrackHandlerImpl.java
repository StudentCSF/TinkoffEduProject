...
import ru.tinkoff.edu.java.bot.сlient.request.RemoveLinkRequest;
...
public record UntrackHandlerImpl(
    ...
    private static final String BOT_REPLY = "Что не отслеживать?";
    private static final String BOT_REPLY_SUCCESS = "Готово! Ссылка больше не отслеживается";
